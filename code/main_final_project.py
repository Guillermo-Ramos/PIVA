...
#---------------------------Setinel pre------------------------------------
imP_S_B8A_pre = io.imread("/Users/blancagilabertlopez/Desktop/projecte-PIVA/incendi-pauls/SETINEL/05-09-2024/2024-05-09-00_00_2024-05-09-23_59_Sentinel-2_L2A_B8A_(Raw).tiff")
imP_S_B12_pre = io.imread("/Users/blancagilabertlopez/Desktop/projecte-PIVA/incendi-pauls/SETINEL/05-09-2024/2024-05-09-00_00_2024-05-09-23_59_Sentinel-2_L2A_B12_(Raw).tiff")
...
#---------------------------Setinel post------------------------------------
imP_S_B8A_post = io.imread("/Users/blancagilabertlopez/Desktop/projecte-PIVA/incendi-pauls/SETINEL/18-6-2026/2026-06-18-00_00_2026-06-18-23_59_Sentinel-2_L2A_B8A_(Raw).tiff")
imP_S_B12_post = io.imread("/Users/blancagilabertlopez/Desktop/projecte-PIVA/incendi-pauls/SETINEL/18-6-2026/2026-06-18-00_00_2026-06-18-23_59_Sentinel-2_L2A_B12_(Raw).tiff")
#informació sobre les imatges
print("Images information")
print("L2A B04:")
...
#plot.subplot(221)
#plot.imshow(imP_L_pre_B4)
#plot.axis('off')
#plot.title('Pre-fire. B4 band')
#plot.subplot(222)
#plot.imshow(imP_L_pre_B7)
#plot.axis('off')
#plot.title('Pre-fire. B7 band')
#plot.subplot(223)
#plot.imshow(imP_L_post_B4)
#plot.axis('off')
#plot.title('Post-fire. B4 band')
#plot.subplot(224)
#plot.imshow(imP_L_post_B7)
#plot.axis('off')
#plot.title('Post-fire. B7 band')
#plot.tight_layout(h_pad=0.4,w_pad=0.4)
#plot.show()
#------------------------------------------------------------------------------------
print("Raw values for B8A (NIR): ", imP_S_B8A_pre.min(),imP_S_B8A_pre.max())
print("Raw values for B12 (SWIR): ", imP_S_B12_pre.min(),imP_S_B12_pre.max())
print("Raw values for B8A (NIR): ", imP_S_B8A_post.min(),imP_S_B8A_post.max())
print("Raw values for B12 (SWIR): ", imP_S_B12_post.min(),imP_S_B12_post.max())
...
params = np.array([[788,981],[374,559]])
dNBR_P_S = dNBR(imP_S_pre_NBR,imP_S_post_NBR,params)
...
dNBR_P_L = dNBR(imP_L_pre_NBR,imP_L_post_NBR,params)
